...
def get_user_data(username):
    ...
    # En producción, usarás /etc/secrets/CREDENTIALS_JSON
...
def get_user_consumption_history(username):
    ...
    """
    credentials_path = os.environ.get("CREDENTIALS_PATH", os.path.join(os.path.dirname(__file__), "credentials.json"))
...
if __name__ == "__main__":
    try:
        ...
        # Cambiar debug=True a debug=False y especificar host
